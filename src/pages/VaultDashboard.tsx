                  ...
                  <tbody>
                    ...
                    >
                      <td className="py-2 px-4">
                        {Number(data.totalCollateral).toFixed(3)} WHYPE
                      </td>
                      <td className="py-2 px-4">
                        {Number(data.totalBorrowed).toFixed(3)} DUSD
                      </td>
                      <td className="py-2 px-4">
                        {Number(data.dusdMinted).toFixed(3)} DUSD
                      </td>
                    </motion.tr>
                  </tbody>
                </table>
              ...
              <div className="bg-[#0B1212] rounded-xl p-0 overflow-x-auto">
                <table className="min-w-full text-left">
                  ...
                  <tbody>
                    ...
                    >
                      <td className="py-2 px-4">
                        {Number(data.bufferFunds).toFixed(3)} WHYPE
                      </td>
                      <td className="py-2 px-4">
                        {Number(data.fundsForExecutor).toFixed(3)} WHYPE
                      </td>
              ...
              <div className="bg-[#0B1212] rounded-xl p-0 overflow-x-auto">
                <table className="min-w-full text-left">
                  ...
                  <tbody>
                    ...
                    >
                      <td className="py-2 px-4">
                        {Number(data.roundData.totalWithdrawalRequests).toFixed(
                          3
                        )}{" "}
                        WHYPE
                      </td>
                      <td className="py-2 px-4">
                        {Number(data.roundData.availableCollateral).toFixed(3)}{" "}
                        WHYPE
                      </td>
                      <td className="py-2 px-4">
                        {formatDate(data.roundData.startTime)}
                      </td>
                      <td className="py-2 px-4">
                        {formatDate(data.roundData.endTime)}
                      </td>
                    </motion.tr>
                  </tbody>
                </table>
