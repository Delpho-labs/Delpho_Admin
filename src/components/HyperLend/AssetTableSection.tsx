...
const AssetTableSection: React.FC<AssetTableSectionProps> = ({ rows, activeTab, onTabChange }) => {
    ...
    return (
        ...
        >
            <h3 className="text-xl font-bold mb-4">Borrow against your HyperCore assets</h3>
